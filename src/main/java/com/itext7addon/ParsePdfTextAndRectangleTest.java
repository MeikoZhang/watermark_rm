...
public class ParsePdfTextAndRectangleTest {
     ...
     String SRC = "C:\\Users\\Administrator\\Desktop\\pdf\\sample.pdf";
     String imgDir = "C:\\Users\\Administrator\\Desktop\\pdf\\img\\";
    // 获取PDF文本内容和图片及坐标
    ...
    public void parse() throws IOException, DocumentException {
        ...
        for (int i = 1; i <= reader.getNumberOfPages(); i++) {
            ...
            for (int j = 0; j < arraysByte.size(); j++) {
                FileOutputStream out = new FileOutputStream(imgDir + j + ".jpg");
